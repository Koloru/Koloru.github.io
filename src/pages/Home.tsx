const Home = () => {
	return (
		<div className='flex flex-col gap-y-5 justify-center w-full h-full py-16 pl-24'>
			...
			<p className='text-gray2 font-light pl-1 w-3/4 text-left leading-loose'>
				I'm <span className='font-bold text-main mx-1'>WEB DEVELOPER</span> who
				seeks novel solutions to novel problems. Knowledge hungry and loves
				learning new things, I can help you build your ideas to life.
